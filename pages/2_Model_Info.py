...
def main():
    ...
    # Main content tabs
    tab1, tab2, tab3, tab4 = st.tabs(["Architecture", "Performance", "Methodology", "Training Details"])
    
    with tab1:
        st.header(f"{selected_model} Architecture")
    ...
    with tab3:
        ...
        if "CNN" in selected_model:
            st.subheader("Convolutional Neural Network Approach")
    ...
    with tab4:
        st.header("Training Details & Configuration")
